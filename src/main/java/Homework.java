public class Homework {
    ...
    static class MyTest {
        ...
        @BeforeEach
        void oneTestMethodBeforeEach() {
            System.out.println("oneTestMethodBeforeEach запущен");
        }

        @Test (order = -1)
        void oneTestMethodTest() {
            System.out.println("oneTestMethodTest запущен");
        }

        @Test (order = -5)
        void twoTestMethodTest() {
            System.out.println("twoTestMethodTest запущен");
        }

        @Test (order = 3)
        void threeTestMethodTest() {
            System.out.println("threeTestMethodTest запущен");
        }

        @BeforeEach
        void twoTestMethodBeforeEach() {
            System.out.println("twoTestMethodBeforeEach запущен");
        }

        @AfterEach
        void oneTestMethodAfterEach() {
            System.out.println("oneTestMethodAfterEach запущен");
        }

        @Skip
        @AfterEach
        void oneTestMethodSkip() {
            System.out.println("oneTestMethodSkip запущен");
        }
